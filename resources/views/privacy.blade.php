...
<body style="padding:3rem">
     ...
     <p>
          <span>Thank you for choosing to be part of our community at NEOMED platform technology LLC (“Company”, “we”, “us”, or
          ...
          us at </span>
         <a href="mailto: info@neomed-v1.elthikkasoft.com">info@neomed-v1.elthikkasoft.com.</a>
     </p>
     <p>
         When you visit our and use our services, you trust us with your personal information. We take your privacy very
     ...
     <p>
         This privacy policy applies to all information collected through our and/or any related services, sales, marketing
         or events (we refer to them collectively in this privacy policy as the "Services").
     </p>
     <p>
     ...
     <div>
         ...
         <p>
             ...
             the (such as posting messages in our online forums or entering competitions, contests or giveaways) or
         ...
         <ul>
             <li>
                 Social Media Login Data. We may provide you with the option to register using social media account
                 details,
         ...
         <table>
             ...
             <tr>
                 ...
                 <td>
                     NEOMED APP wants to access your location to help us to find nearest service provider to your location
                 </td>
             </tr>
             <tr>
                 <td>
                 ...
                 <td>
                     NEOMED APP wants to access your camera to use it through video calls
                 </td>
             </tr>
             <tr>
                 <td>
                     Files in media/shared directories
                 </td>
                 <td>
                     NEOMED APP wants to access your media and files, you can access it later in chat or orders
                 </td>
             </tr>
             <tr>
                 <td>
                 ...
                 <td>
                     NEOMED APP wants to record audio after your permission  ,so  you can record audio with your voice in foreground to send it to your doctor
                 </td>
             </tr>
             <tr>
                 <td>
                     SSID from ACCESS_WIFI_STATE <br>
                     Bluetooth from BLUETOOTH
                 </td><td>
                     NEOMED APP wants to access your SSID and Bluetooth, So it can establish an audio or video call
                 </td>
             </tr>
             <tr>
                 <td>
                     ...
                     READ_PHONE_STATE permission helps NEOMED APP to identify your phone while intializing  video and audio calls with doctors
                 </td>
             </tr>
             <tr>
                 <td>
                     ...
                     NEOMED APP wants access to read/write external storage to enable you to send and receive data like medical reports, prescriptions and test-labs result
                 </td>
             </tr>
             <tr>
                 <td>
                     ...
                     NEOMED APP wants to access your media and files so you can post it while order creation to send doctors your reports also  you can access it later in chat or orders               </td>
             </tr>
             </tbody>
         </table>
         <h2>
     ...
     <div>
         ...
         <ul>
             <li>
                 ...
                 parties to use tracking technology on the , which will enable them to collect data about how you interact
                 with the over time. This information may be used to, among other things, analyze and track data,
                 determine the popularity of certain content and better understand online activity. Unless described in
             ...
             <li>
                 ...
                 personal information may be viewed by all users and may be publicly distributed outside the in
                 ...
                 your activity. Similarly, other users will be able to view descriptions of your activity, communicate
     ...
     <div>
         ...
         <p>
             Our offer you the ability to register and login using your third party social media account details (like your
             ...
             provider concerned, but will often include your name, e-mail address, friends list, profile picture as well as
         ...
         <p>
             ...
             are otherwise made clear to you on the . Please note that we do not control, and are not responsible for,
     ...
     <div>
         ...
         <p>
             ...
             your personal information in accordance with this privacy policy and applicable law.
         </p>
     </div>
     <div>
         <h1>
         ...
         <p>
             The may contain advertisements from third parties that are not affiliated with us and which may link to other
     ...
     <div>
         ...
         <p>
               <span>We do not knowingly solicit data from or market to children under 18 years of age. By using the , you
     ...
     <div>
         ...
         <p>
               <span>If you are resident in the European Economic Area and you believe we are unlawfully processing your personal
             ...
             <a href="https://ec.europa.eu/info/law/law-topic/data-protection_en" target="_blank">Data protection </a>
         </p>
         <p>
             Account Information
         </p>
         ...
         <ul>
             ...
             <li>
                 ...
                 You will then be removed from the marketing email list – however, we will still need to send you
     ...
     <div>
         ...
         <p>
             ...
             or delete your personal information, please submit a request form by clicking here. We will respond to your
