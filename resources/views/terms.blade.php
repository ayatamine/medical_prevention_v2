...
@import url("https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap");
        ...
        body p{font-weight: 600;line-height: 1.8;}
        .text-center{text-align: center}
    </style>
@endsection
@section('content')

<div class="" style="padding: 3rem;font-family">
    ...
    <div>
         ...
         <p>
              Welcome to Neomed platform LLC (“Company”, “we”, “our”, “us”)!
         </p>
         <p>
              <span>
                   These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at
              </span>
              <a href="https://www.neomed-v1.elthikkasoft.com">www.neomed-v1.elthikkasoft.com</a>
              <span>
                   (together or individually “Service”) operated by Neomed platform LLC.
              </span>
         </p>
         <p>
         ...
         <p>
              ...
              <a href="mailto: support@neomed-v1.elthikkasoft.com">support@neomed-v1.elthikkasoft.com</a>
              <span>
    ...
    <div>
         ...
         <p>
              <span>By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and other information we may send. However, you may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or by emailing at</span>
              <a href="mailto: support@neomed-v1.elthikkasoft.com">support@neomed-v1.elthikkasoft.com.</a>
         </p>
    </div>
    <div>
    ...
    <div>
         ...
         <p>
              Any contests, sweepstakes or other promotions (collectively, “Promotions”) made available through Service may
    ...
    <div>
         ...
         <p>
              We issue refunds for orders cancelled within 30min of the original purchase of the Contract for orders made
              prior 24h than the booked time.
         </p>
         <p>
              In case you have a confirmed request of service and at the time of the booking (i) Neomed care’s team or the
              service provider can’t get hold of you using the contact information provided through the app or website (ii)
              you refuse to see them (iii) you are not complying to the health/legal regulation requested by the service
              provider (iiii) you have not followed the request of the service provider which is provided to you prior or
              during the service We have the right to cancel your order and no refund is to be issued.
         </p>
    </div>
    <div>
         <h1>
         ...
         <p>
              Content found on or through this Service are the property of Neomed platform LLC or used with permission. You
              may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or
    ...
    <div>
         ...
         <p>
              ...
              will remain the exclusive property of Neomed platform LLC and its licensors. Service is protected by copyright,
              trademark, and other laws of and foreign countries. Our trademarks may not be used in connection with any
              product or service without the prior written consent of Neomed platform LLC.
         </p>
    </div>
    <div>
         <h1>
         ...
         <p>
              <span>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has
              been copied in a way that constitutes copyright infringement, please submit your claim via email to</span>
              <a href="mailto: support@neomed-v1.elthikkasoft.com">support@neomed-v1.elthikkasoft.com</a>
              <span>, with the subject line: “Copyright Infringement” and include in your claim a detailed
              description of the alleged Infringement as detailed below, under “DMCA Notice and Procedure for Copyright
              Infringement Claims”</span>
         </p>
         <p>
    ...
    <div>
         ...
         <p>
              <span>You can contact our Copyright Agent via email at </span>
              <a href="mailto: support@neomed-v1.elthikkasoft.com">support@neomed-v1.elthikkasoft.com.</a>
         </p>
    </div>
    <div>
         ...
         <p>
              لان كير تظهر كافة الأسعار في التطبيق لكل خدمة وتعتمد الأسعار لكل خدمة قبل الطلب ويحتمل أن يختلف السعر بحسب
              المنطقة أو زمن طلب الخدمة وهناك أسعار تعتمد على المسافة أو وقت الخدمة، كما أنه يجوز لـ لان كير تحديث الأسعار
              في أي وقت ويجب أن تكون على اطلاع دائم.
         </p>
         <p>
              تكون طريقة الدفع المعتمدة المحددة في تطبيق أو موقع لان كير فقط ولا يقبل الدفع (كاش) لأي سبباً كان.
         </p>
    </div>
    <div>
         <h1>
    ...
    <div>
         ...
         <p>
              ...
              THE COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY, OR AVAILABILITY OF THE SERVICES. WITHOUT LIMITING
              THE FOREGOING, NEITHER COMPANY NOR ANYONE ASSOCIATED WITH COMPANY REPRESENTS OR WARRANTS THAT THE SERVICES,
              THEIR CONTENT, OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE SERVICES WILL BE ACCURATE, RELIABLE, ERROR-FREE,
              OR UNINTERRUPTED, THAT DEFECTS WILL BE CORRECTED, THAT THE SERVICES OR THE SERVER THAT MAKES IT AVAILABLE ARE
              FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS OR THAT THE SERVICES OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE
    ...
    <div>
         ...
         <p>
              ...
              FEES AND ALL RELATED COSTS AND EXPENSES OF LITIGATION AND ARBITRATION, OR AT TRIAL OR ON APPEAL, IF ANY,
              WHETHER OR NOT LITIGATION OR ARBITRATION IS INSTITUTED), WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE, OR
              OTHER TORTIOUS ACTION, OR ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT, INCLUDING WITHOUT LIMITATION
    ...
    <div>
         ...
         <p>
              These Terms shall be governed and construed in accordance with the laws of Saudi Arabia, which governing law
    ...
    <div>
         ...
         <p>
              <span>Please send your feedback, comments, requests for technical support by email: </span>
              <a href="mailto: support@neomed-v1.elthikkasoft.com">support@neomed-v1.elthikkasoft.com.</a>
         </p>
    </div>
