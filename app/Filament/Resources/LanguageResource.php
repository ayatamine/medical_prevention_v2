    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->required()
                ->label(trans('name'))
                ->unique(table: Language::class,ignoreRecord: true)
                ->maxLength(150),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('label')->label('Label')->sortable()->searchable(),
                Tables\Columns\TextColumn::make('direction')->label('Direction')->sortable(),
